...
void test_multiply_postive_and_negative_numbers(void){
    TEST_ASSERT_EQUAL(-20,multiply(2,-10));
}
...
void test_divide_negative_numbers(void){
    TEST_ASSERT_EQUAL(5,divide(-50,-10));
}
...
int main(void){
    ...
    RUN_TEST(test_multiply_postive_and_negative_numbers);
